...
escrever o código do diagrama, em vez de modelar direto no PlantUML e ter que refazer(já que é uma ferramenta nova pra nós).

Registrar estatística de uso não tem ator porque é disparada automaticamente pelo sistema sempre que um aluno adiciona um eBook à estante.
